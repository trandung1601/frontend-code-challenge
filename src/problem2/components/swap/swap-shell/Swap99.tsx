...
import SwapPanel from '../swap-panel/SwapPanel'
import SlippageSelector from '../slippage-selector/SlippageSelector'
import SwapDetails from '../swap-details/SwapDetails'
